...
class UserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'account_type', 'birth_date','gender', 'postal_code', 'city','country', 'street_address', 'phone_no']
...
class UserUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance:
            ...
            if user_account:
                ...
                self.fields['phone_no'].initial = user_address.phone_no
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            user_address.phone_no = self.cleaned_data['phone_no']
